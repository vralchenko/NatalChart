...
export const PlanetTable: React.FC<Props> = ({ planets }) => (
  <TableContainer component={Paper} sx={{
    ...
    <Table size="small">
      <TableHead>
        <TableRow>
          <TableCell sx={{ color: '#a855f7', fontWeight: 700 }}>Planet</TableCell>
          <TableCell sx={{ color: '#a855f7', fontWeight: 700 }}>Sign</TableCell>
          <TableCell sx={{ color: '#a855f7', fontWeight: 700 }}>Position</TableCell>
          <TableCell sx={{ color: '#a855f7', fontWeight: 700 }}>House</TableCell>
          <TableCell sx={{ color: '#a855f7', fontWeight: 700 }}>Speed</TableCell>
        </TableRow>
      </TableHead>
      <TableBody>
        {planets.map((p) => (
